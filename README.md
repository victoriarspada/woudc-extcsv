...
Python package providing a parser for files of the
...
woudc-extcsv requires Python 3 or above.
...
### ExtendedCSV Objects
The ExtendedCSV class is used in the Reader and Writer classes, and can be used to both read and write to an Extended CSV object.
